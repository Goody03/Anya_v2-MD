...
module.exports = {
  botname: process.env.BotName || "GOODY", 
  author: process.env.Author || "@goody",
  packname: process.env.PackName || "goodie stk",
  socialLink: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© Goody Bot ⚡",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "Goody",
  ownernumber: process.env.Owner_Number || "2348051722599",
